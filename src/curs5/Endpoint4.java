 ...
 */
@WebServlet("/Endpoint4")
public class Endpoint4 extends HttpServlet {
    	    ...
    	    throws ServletException, IOException {
    	        ...
    	        try {
    	    		...
    	    		// Load database driver if it's not already loaded.
    	              ...
    	              String query =
    	                "SELECT * FROM contact WHERE prenume='Florin' and varsta = 25";
    	              ...
    	              while(resultSet.next()) {
    	                ...
    	                out.println("Your name is " + nume + varsta);
